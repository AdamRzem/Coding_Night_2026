...
<div class="space-y-6">
	...
	<div class="bg-white dark:bg-gray-900 rounded-2xl shadow-sm border border-gray-200 dark:border-gray-800 p-6 space-y-6">
		<div>
			...
			<p class="text-sm text-gray-500 dark:text-gray-400 mb-5">Choose how BlogApp looks to you</p>
			...
			<div class="grid sm:grid-cols-2 gap-4 max-w-lg">
				<button
					...
					class="relative flex flex-col items-center gap-3 p-6 rounded-2xl border-2 transition-all duration-200 cursor-pointer
						{theme.mode === 'light'
						? 'border-indigo-500 bg-indigo-50 dark:bg-indigo-950/30 shadow-sm shadow-indigo-100 dark:shadow-indigo-900/20'
	...
	<div class="bg-white dark:bg-gray-900 rounded-2xl shadow-sm border border-gray-200 dark:border-gray-800 p-6">
		...
		<p class="text-sm text-gray-500 dark:text-gray-400">
			BlogApp v1.0 &mdash; Built with SvelteKit & Supabase
		</p>
	</div>
</div>
